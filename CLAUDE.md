...
**Current phase: Phase 0 closed 2026-07-23. Phase 1 (skeleton with eyes) is authorized; no application code exists yet.** Phase-0/0.5 landed `docs/phase0-measurements.md` (raw), `docs/PHASE0_FINDINGS_SUMMARY.md` (condensed), the locked roster, and **Config B placement** (solo-GPU0 pinning + CPU residents — the tensor-split design was measured and reversed). Before writing `app/` or `web/` code, check `PLAN.md` §5 and `AGENTS.md` "Current phase".
