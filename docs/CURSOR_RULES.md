...
Complete `.cursor/rules/` content for the rebuild. **These blocks are already live** in `.cursor/rules/` — `001-stack`, `002-boundaries` (always-apply) · `003-python-backend`, `004-frontend`, `005-config`, `006-testing`, `010-benchmark-eval-methodology` (glob) · `007-git-worktrees`, `008-remote-box`, `009-subagents` (agent-requested).
